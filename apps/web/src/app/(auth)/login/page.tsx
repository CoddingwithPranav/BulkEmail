...
const registerSchema = z.object({
  ...
  phone: z.string().regex(/^9[78]\d{8}$/, "Invalid Nepali phone number"),
...
export default function AuthPage() {
  ...
  const onLogin = async (data: LoginForm) => {
    try {
      ...
      const { token, user } = res.data; // adjust according to your actual response

      // Save token (you can use cookies, localStorage, or Zustand)
