...
init_env_map() {
    ...
    ENV_MAP["apps/api"]="NODE_ENV,DATABASE_URL,REDIS_URL,REDIS_HOST,REDIS_PORT,PORT,API_PORT,JWT_SECRET,IMAGEKIT_PRIVATE_KEY,IMAGEKIT_PUBLIC_KEY,IMAGEKIT_URL_ENDPOINT,GMAIL_USER,GMAIL_APP_PASSWORD,ESEWA_SECRET_KEY,ESEWA_PRODUCT_CODE,CLIENT_URL,BACKEND_URL,FRONTEND_URL"
    ...
    ENV_MAP["apps/worker-file-processor"]="NODE_ENV,DATABASE_URL,REDIS_URL,REDIS_HOST,REDIS_PORT,IMAGEKIT_PRIVATE_KEY,IMAGEKIT_PUBLIC_KEY,IMAGEKIT_URL_ENDPOINT"
}
